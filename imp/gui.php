            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Address: 40 Kilmington Road Davoren Park 5113 SA</li>
                            <li>Phone: +61 42.670.0655</li>
                            <li>Email: support@farmharvesthub.com.au</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-1">
                    <div class="footer__widget">
                        ...
                        <ul>
                            ...
                            <li><a href="?=about">Secure Shopping</a></li>
                            <li><a href="?=about">Delivery infomation</a></li>
