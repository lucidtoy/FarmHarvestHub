...
START TRANSACTION;
USE `FHH`;
INSERT INTO `FHH`.`store` (`store_id`, `store_name`, `address`, `email`, `phone`, `admin_id`, `created_by`, `created_at`) VALUES (1, 'Farmer\'s Warehouse', '50 Magpie Street (next door to Bunnings)', 'sales@farmerswarehouse.com.au', '02 4992 1639', 1, 'lucidtoy@gmail.com', '2023-11-28 00:00:00');
