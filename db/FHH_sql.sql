...
-- Table `FHH`.`farm`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `FHH`.`farm` ;

CREATE TABLE IF NOT EXISTS `FHH`.`farm` (
...
INSERT INTO `FHH`.`page_tbl` (`page_id`, `page_code`, `page_title`, `url`, `description`, `defaults`, `access_level`) VALUES (5, 'FARM', 'FARM', 'pages/farm.php', 'Farm Front', 'N', 'PUBLIC');
...
INSERT INTO `FHH`.`page_tbl` (`page_id`, `page_code`, `page_title`, `url`, `description`, `defaults`, `access_level`) VALUES (11, 'LOGOUT', 'Logout Page', 'pages/logout.php', 'Logout Page', 'N', 'PRIVATE');
...
-- -----------------------------------------------------
-- Data for table `FHH`.`resp_tbl`
-- -----------------------------------------------------
START TRANSACTION;
USE `FHH`;
INSERT INTO `FHH`.`resp_tbl` (`resp_id`, `page_id`, `user_type_id`) VALUES (1, 8, 1);
INSERT INTO `FHH`.`resp_tbl` (`resp_id`, `page_id`, `user_type_id`) VALUES (2, 8, 2);
INSERT INTO `FHH`.`resp_tbl` (`resp_id`, `page_id`, `user_type_id`) VALUES (3, 8, 3);
INSERT INTO `FHH`.`resp_tbl` (`resp_id`, `page_id`, `user_type_id`) VALUES (4, 9, 1);
INSERT INTO `FHH`.`resp_tbl` (`resp_id`, `page_id`, `user_type_id`) VALUES (5, 9, 2);
INSERT INTO `FHH`.`resp_tbl` (`resp_id`, `page_id`, `user_type_id`) VALUES (6, 9, 3);
INSERT INTO `FHH`.`resp_tbl` (`resp_id`, `page_id`, `user_type_id`) VALUES (7, 11, 1);
INSERT INTO `FHH`.`resp_tbl` (`resp_id`, `page_id`, `user_type_id`) VALUES (8, 11, 2);
INSERT INTO `FHH`.`resp_tbl` (`resp_id`, `page_id`, `user_type_id`) VALUES (9, 11, 3);

COMMIT;


-- -----------------------------------------------------
-- Data for table `FHH`.`users`
-- -----------------------------------------------------
START TRANSACTION;
USE `FHH`;
INSERT INTO `FHH`.`users` (`user_id`, `email`, `phone`, `password`, `firstname`, `lastname`, `last_logon`, `user_status`, `user_type_id`, `address`, `city`, `state`) VALUES (1, 'lucidtoy@gmail.com', '0426700655', '5f4dcc3b5aa765d61d8327deb882cf99', 'Solomon', 'Oladokun', '2023-11-28 00:00:00', 'ACTIVE', 2, '40 Kilmington Road', 'Davoren Park', 'SA');
INSERT INTO `FHH`.`users` (`user_id`, `email`, `phone`, `password`, `firstname`, `lastname`, `last_logon`, `user_status`, `user_type_id`, `address`, `city`, `state`) VALUES (2, 'ooladokun3044@gmail.com', '0426700655', '5f4dcc3b5aa765d61d8327deb882cf99', 'Andrew', 'Smith', '2023-11-29 00:00:00', 'ACTIVE', 2, '40 Kilmington Road', 'Davoren Park', NULL);
INSERT INTO `FHH`.`users` (`user_id`, `email`, `phone`, `password`, `firstname`, `lastname`, `last_logon`, `user_status`, `user_type_id`, `address`, `city`, `state`) VALUES (3, 'lucidtoy@yahoo.com', '0426700655', '5f4dcc3b5aa765d61d8327deb882cf99', 'Oladayo', 'Oladokun', '2023-11-29 00:00:00', 'ACTIVE', 2, '40 Kilmington Road', 'Davoren Park', NULL);
INSERT INTO `FHH`.`users` (`user_id`, `email`, `phone`, `password`, `firstname`, `lastname`, `last_logon`, `user_status`, `user_type_id`, `address`, `city`, `state`) VALUES (4, 'info@stadok.com', '0426700655', '5f4dcc3b5aa765d61d8327deb882cf99', 'Vincent', 'Uba', '2023-11-29 00:00:00', 'ACTIVE', 2, '40 Kilmington Road', 'Davoren Park', NULL);

COMMIT;


-- -----------------------------------------------------
-- Data for table `FHH`.`farm`
-- -----------------------------------------------------
START TRANSACTION;
USE `FHH`;
INSERT INTO `FHH`.`farm` (`farm_id`, `farm_name`, `address`, `email`, `phone`, `admin_id`, `created_by`, `created_at`) VALUES (1, 'Farmers Warehouse', '50 Magpie Street (next door to Bunnings)', 'sales@farmerswarehouse.com.au', '02 4992 1639', 1, 'lucidtoy@gmail.com', '2023-11-28 00:00:00');
INSERT INTO `FHH`.`farm` (`farm_id`, `farm_name`, `address`, `email`, `phone`, `admin_id`, `created_by`, `created_at`) VALUES (2, 'Andrews Farm', '27 Andrews Farm', 'info@andrewsfarm.com.au', '03 4562 7890', 2, 'lucidtoy@gmail.com', '2023-11-28 00:00:00');
INSERT INTO `FHH`.`farm` (`farm_id`, `farm_name`, `address`, `email`, `phone`, `admin_id`, `created_by`, `created_at`) VALUES (3, 'Ola Farms', '33d orlando avenue', 'info@ooladokun3044.com.au', '04 2670 0655', 3, 'lucidtoy@gmail.com', '2023-11-28 00:00:00');
INSERT INTO `FHH`.`farm` (`farm_id`, `farm_name`, `address`, `email`, `phone`, `admin_id`, `created_by`, `created_at`) VALUES (4, 'Vincent Carrots', '15A wilkins road', 'vincent@carrots.com.au', '04 2670 0655', 4, 'lucidtoy@gmail.com', '2023-11-28 00:00:00');

COMMIT;


-- -----------------------------------------------------
-- Data for table `FHH`.`product_category`
-- -----------------------------------------------------
START TRANSACTION;
USE `FHH`;
INSERT INTO `FHH`.`product_category` (`category_id`, `category_name`, `description`) VALUES (1, 'Fresh Produce', 'Fresh Produce');
INSERT INTO `FHH`.`product_category` (`category_id`, `category_name`, `description`) VALUES (2, 'Vegetables', 'Vegetables');
INSERT INTO `FHH`.`product_category` (`category_id`, `category_name`, `description`) VALUES (3, 'Fruit & Nut Gifts', 'Fruit & Nut Gifts');
INSERT INTO `FHH`.`product_category` (`category_id`, `category_name`, `description`) VALUES (4, 'Fresh Berries', 'Fresh Berries');
INSERT INTO `FHH`.`product_category` (`category_id`, `category_name`, `description`) VALUES (5, 'Sea Foods', 'Sea Foods');
INSERT INTO `FHH`.`product_category` (`category_id`, `category_name`, `description`) VALUES (6, 'Butter & Eggs', 'Butter & Eggs');
INSERT INTO `FHH`.`product_category` (`category_id`, `category_name`, `description`) VALUES (7, 'Fresh Onion', 'Fresh Onion');
