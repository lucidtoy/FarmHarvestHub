...
-- -----------------------------------------------------
-- Data for table `FHH`.`store`
-- -----------------------------------------------------
START TRANSACTION;
USE `FHH`;
INSERT INTO `FHH`.`store` (`store_id`, `store_name`, `address`, `email`, `phone`, `admin_id`, `created_by`, `created_at`) VALUES (1, 'Farmers Warehouse', '50 Magpie Street (next door to Bunnings)', 'sales@farmerswarehouse.com.au', '02 4992 1639', 1, 'lucidtoy@gmail.com', '2023-11-28 00:00:00');
INSERT INTO `FHH`.`store` (`store_id`, `store_name`, `address`, `email`, `phone`, `admin_id`, `created_by`, `created_at`) VALUES (2, 'Andrews Farm', '27 Andrews Farm', 'info@andrewsfarm.com.au', '03 4562 7890', 2, 'lucidtoy@gmail.com', '2023-11-28 00:00:00');
INSERT INTO `FHH`.`store` (`store_id`, `store_name`, `address`, `email`, `phone`, `admin_id`, `created_by`, `created_at`) VALUES (3, 'Ola Farms', '33d orlando avenue', 'info@ooladokun3044.com.au', '04 2670 0655', 3, 'lucidtoy@gmail.com', '2023-11-28 00:00:00');
INSERT INTO `FHH`.`store` (`store_id`, `store_name`, `address`, `email`, `phone`, `admin_id`, `created_by`, `created_at`) VALUES (4, 'Vincent Carrots', '15A wilkins road', 'vincent@carrots.com.au', '04 2670 0655', 4, 'lucidtoy@gmail.com', '2023-11-28 00:00:00');
...
START TRANSACTION;
USE `FHH`;
INSERT INTO `FHH`.`product_category` (`category_id`, `category_name`, `description`) VALUES (1, 'Fresh Meat', 'Fresh Meat');
